...
States: **36**
Distinct state+city pairs: **8621**

## RC-1 legacy equality vs unified contains (popular deep links)

| City | State | Legacy (=) | Unified (contains) | Delta |
|------|-------|--------------|--------------------|-------|
...
- Popular cities: **PASS**
- Engineering/Medical/Nursing: **PASS**
- City self-match failures: **0** (PASS)
