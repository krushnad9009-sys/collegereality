      ...
      body: prefsAsync.when(
        ...
        data: (prefs) => ListView(
          ...
          children: [
            ...
            _toggle(ref, prefs, 'Review approved', prefs.reviewApproved,
                (v) => prefs.copyWith(reviewApproved: v)),
            _toggle(ref, prefs, 'Review interactions', prefs.reviewInteraction,
                (v) => prefs.copyWith(reviewInteraction: v)),
            const Divider(),
            _sectionTitle('Verification & Community'),
            _toggle(ref, prefs, 'Verification updates', prefs.verificationUpdates,
                (v) => prefs.copyWith(verificationUpdates: v)),
            _toggle(ref, prefs, 'Community posts & comments', prefs.communityUpdates,
                (v) => prefs.copyWith(communityUpdates: v)),
            _toggle(ref, prefs, 'Admin announcements', prefs.adminAnnouncements,
                (v) => prefs.copyWith(adminAnnouncements: v)),
            const Divider(),
            ...
            const Divider(),
            _sectionTitle('Careers'),
            _toggle(ref, prefs, 'New job listings', prefs.newJob,
                (v) => prefs.copyWith(newJob: v)),
            _toggle(ref, prefs, 'New internship listings', prefs.newInternship,
                (v) => prefs.copyWith(newInternship: v)),
            _toggle(ref, prefs, 'Application status updates', prefs.applicationUpdate,
                (v) => prefs.copyWith(applicationUpdate: v)),
            const Divider(),
