...
class AnswerCardWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final highlightColor = answer.isAccepted
      ...
      child: Container(
        decoration: highlightColor != null
            ? BoxDecoration(
                ...
                border: Border.all(color: highlightColor.withValues(alpha: 0.4), width: 1.5),
              )
            : null,
        padding: highlightColor != null ? const EdgeInsets.all(1.5) : EdgeInsets.zero,
        child: PremiumCard(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  PopupMenuButton<String>(
                    icon: Icon(Icons.more_vert_rounded, size: 18, color: tokens.textTertiary),
              ...
              QuestionRichTextUtils.buildRichText(
                answer.body,
                baseStyle: AppFonts.plusJakarta(fontSize: 14, height: 1.5, color: tokens.textPrimary),
              ),
                ...
                children: [
                  ...
                  if (canAccept && !answer.isAccepted)
                    TextButton.icon(
                      ...
                      label: Text('Accept', style: AppFonts.plusJakarta(fontSize: 12, fontWeight: FontWeight.w600)),
                    ),
                  if (canMarkHelpful && !answer.isMostHelpful)
                    TextButton.icon(
                      ...
                      label: Text('Helpful', style: AppFonts.plusJakarta(fontSize: 12, fontWeight: FontWeight.w600)),
                    ),
                ],
              ),
              AnswerReplySection(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive ? primary.withValues(alpha: 0.12) : tokens.surfaceMuted,
          borderRadius: BorderRadius.circular(8),
        ),
        child: Row(
          ...
          children: [
            Icon(
              icon,
              size: 16,
              color: isActive ? primary : tokens.textSecondary,
            ),
